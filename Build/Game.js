    ...
    async function ProtagonistHospital() {
        ...
        let text = {
            Protagonist: {
                ...
                S2230_04: "Freut mich! Mir geht es an sich ganz gut, aber ich fühle immer noch einen leichten Schmerz… aber habe etwas dagegen bekommen.",
                ...
                S2240_06: "Lass mich raten… Du gibst dich mit ihm ab und spielst sein Spiel mit, um mehr herauszufinden?",
                ...
                S2242_02: "Und jetzt ist auch dein Bruder weg, du hast kein Geld und bist ganz alleine. Wow, ich weiß nicht was ich sagen soll…",
            ...
            Sumi: {
                ...
                S2200_09: "Jedenfalls hast du mich trotzdem irgendwie gerettet, weswegen ich gewartet habe bis du aufwachst… um mich zu bedanken… also danke.",
                ...
                S2200_17: "Du kannst Fernsehen oder deine Zimmernachbarn kennenlernen, mir egal. Ich muss aber jetzt gehen, hab noch etwas zu erledigen.",
                ...
                S2220_09: "Ich weiß doch… aber wenn sich dein Zustand noch verschlechtert… und ich dich auch noch verliere… dann bin ich alleine.",
                ...
                S2240_03: "Na gut, wenn du schon darauf bestehst. Jetzt gibt es keinen Rückzieher mehr. Mein Bruder Shou ist - oder eher war - der Anführer dieser kleinen Möchtegern-Gang…. Er war ein herzensguter Mensch und stark, alle haben ihm vertraut und waren stolz ihm zu folgen. Auch wenn manche seiner Geschäfte nicht gerade die saubersten waren, er hat nie jemand unschuldigen verletzt. Nobu, der Typ, der dich zusammengeschlagen hat, war sein Vize und bester Freund. Doch irgendwas ist zwischen ihnen passiert und Nobu hat sich zum Schlimmsten entwickelt. Irgendwann ist mein Bruder verschwunden und ich wette, Nobu steckt irgendwie dahinter.",
            ...
            Yuko: {
                ...
                S2220_10: "Schatz, egal was passiert… ich werde immer bei dir sein… und ich bin mir sicher, dass dein Bruder zurückkommen wird.",
            ...
            Reporter: {
                ...
                S2210_03: "… da dieser Junge Mitglied einer Gang ist, geht die Polizei davon aus, dass er in illegale Machenschaften reingezogen wurde …",
        ...
        await Endabgabe.ƒS.Speech.tell(Endabgabe.characters.protagonist, "Noch mehr Menschen?");
        ...
        switch (flirtOrNot) {
            case flirtOrNotAnswer.not:
                ...
                await Endabgabe.ƒS.Speech.tell(Endabgabe.characters.sumi, "Ich sollte gehen, bis morgen.");
                Endabgabe.ƒS.Speech.hide();
                await Endabgabe.ƒS.Character.animate(Endabgabe.characters.sumi, Endabgabe.characters.sumi.pose.shy, Endabgabe.animate(Endabgabe.animations.leftToLeftOut));
                break;
    ...
    async function RightPlace() {
        ...
        let text = {
            ...
            Sumi: {
                ...
                S41212_14: "Das ist " + Endabgabe.dataForSave.nameProtagonist + ". Als Nobu und einige seiner Leute mich bedrängt haben und sich an mir vergehen wollten, tauchte " + Endabgabe.dataForSave.nameProtagonist + " plötzlich auf und rettete mich. Der gesamte Plan stammte von " + Endabgabe.dataForSave.nameProtagonist,
                ...
                S41222_16: "Das ist " + Endabgabe.dataForSave.nameProtagonist + ". Als Nobu und einige seiner Leute mich bedrängt haben und sich an mir vergehen wollten, tauchte " + Endabgabe.dataForSave.nameProtagonist + " plötzlich auf und rettete mich. Der gesamte Plan stammte von " + Endabgabe.dataForSave.nameProtagonist,
    ...
    async function SumiHospital() {
        ...
        let text = {
            Protagonist: {
                ...
                S2310_08: "Lass mich raten… Du gibst dich mit ihm ab und spielst sein Spiel mit, um mehr herauszufinden?",
            ...
            Sumi: {
                ...
                S2310_05: "Na gut, wenn du schon darauf bestehst. Jetzt gibt es keinen Rückzieher mehr. Mein Bruder Shou ist - oder eher war - der Anführer dieser kleinen Möchtegern-Gang…. Er war ein herzensguter Mensch und stark, alle haben ihm vertraut und waren stolz ihm zu folgen. Auch wenn manche seiner Geschäfte nicht gerade die saubersten waren, er hat nie jemand unschuldigen verletzt. Nobu, der Typ, der dich zusammengeschlagen hat, war sein Vize und bester Freund. Doch irgendwas ist zwischen ihnen passiert und Nobu hat sich zum Schlimmsten entwickelt. Irgendwann ist mein Bruder verschwunden und ich wette, Nobu steckt irgendwie dahinter.",
                S2310_07: "Ja, aber am letzten Abend, an dem ich meinen Bruder sah, ist er zu einem Gang-Treffen aufgebrochen und laut Nobu nie dort angekommen. Seitdem macht er sich auch so ekelhaft an mich ran. Er ist der Meinung, dass als sein bester Freund es jetzt seine Aufgabe ist mich zu beschützen. Und da er der Vize ist, wurde er natürlich zum Anführer und strukturiert die Gang um… alle Prinzipien und Grenzen, die mein Bruder aufgestellt hat, ignoriert er komplett. Es scheint alles perfekt für ihn zu laufen, seitdem Shou weg ist…. Ich habe das im Gefühl…",
                ...
                S2320_05b: "Jedenfalls hat Shou angefangen mit zwielichtigen Leuten abzuhängen. Als uns dann unser Vater verlassen hat, da er das alles nicht ausgehalten hat, sah sich Shou als Mann im Haus… Und als unsere Mutter schwerkrank wurde und in dieses Krankenhaus kam gründete er die Gang, um an Geld zu kommen, damit wir uns über Wasser halten und die Krankenhaus Rechnungen meiner Mutter bezahlen können.",
                S2320_07: "Ich brauche kein Mitleid… meine Mutter wird wieder gesund, mein Vater wird zurückkommen und meinen Bruder werde ich finden. Auch wenn meine Familie wie eine Vase zerbrochen ist und ohne meinen kleinen Bruder ein Teil fehlt… sie kann wieder zusammengeklebt werden, selbst wenn die Risse bleiben werden.",
    ...
    async function SumisHome() {
        ...
        let text = {
            Protagonist: {
                ...
                S2120_06: "Lass mich raten… Du gibst dich mit ihm ab und spielst sein Spiel mit, um mehr herauszufinden?",
            ...
            Sumi: {
                ...
                S2100_19: "Tut mir leid, dass du das mitanhören musstest… komm, ich verarzte dich fertig, dann kannst du nach Hause. Willst du solange etwas zum Trinken haben?",
                S2100_20: "Alles klar.",
                ...
                S2120_03: "Na gut, wenn du schon darauf bestehst. Jetzt gibt es keinen Rückzieher mehr. Mein Bruder Shou ist - oder eher war - der Anführer dieser kleinen Möchtegern-Gang…. Er war ein herzensguter Mensch und stark, alle haben ihm vertraut und waren stolz ihm zu folgen. Auch wenn manche seiner Geschäfte nicht gerade die saubersten waren, er hat nie jemand unschuldigen verletzt. Nobu, der Typ, der eben hier war, war sein Vize und bester Freund. Doch irgendwas ist zwischen ihnen passiert und Nobu hat sich zum Schlimmsten entwickelt. Irgendwann ist mein Bruder verschwunden und ich wette, Nobu steckt irgendwie dahinter.",
                S2120_05: "Ja, aber am letzten Abend, an dem ich meinen Bruder sah, ist er zu einem Gang-Treffen aufgebrochen und laut Nobu nie dort angekommen. Seitdem macht er sich auch so ekelhaft an mich ran. Er ist der Meinung, dass als sein bester Freund es jetzt seine Aufgabe ist mich zu beschützen. Und da er der Vize ist, wurde er natürlich zum Anführer und strukturiert die Gang um… alle Prinzipien und Grenzen, die mein Bruder aufgestellt hat, ignoriert er komplett. Es scheint alles perfekt für ihn zu laufen, seitdem Shou weg ist…. Ich habe das im Gefühl...",
                ...
                S2122_01b: "Jedenfalls hat Shou angefangen mit zwielichtigen Leuten abzuhängen. Als uns dann unser Vater verlassen hat, da er das alles nicht ausgehalten hat, sah sich Shou als Mann im Haus… Und als unsere Mutter schwerkrank wurde und ins Krankenhaus kam, gründete er die Gang, um an Geld zu kommen, damit wir uns über Wasser halten und die Krankenhaus Rechnungen meiner Mutter bezahlen können.",
                S2122_03: "Ich brauche kein Mitleid… meine Mutter wird wieder gesund, mein Vater wird zurückkommen und meinen Bruder werde ich finden. Auch wenn meine Familie wie eine Vase zerbrochen ist und ohne meinen kleinen Bruder ein Teil fehlt… sie kann wieder zusammengeklebt werden, selbst wenn die Risse bleiben werden.",
            ...
            Nobu: {
                ...
                S2100_12: "Es tut mir leid, dass Shou immer noch vermisst wird, Sumi… Aber seien wir ganz ehrlich. Dein Bruder hat schon immer seine Nase in Dinge reingesteckt, die ihn nichts angingen, wahrscheinlich hat er sich mit den falschen Leuten angelegt und seine verdiente Strafe bezahlt.",
...
(function (Endabgabe) {
    async function ThePlanFailed() {
        ...
        let text = {
            ...
            Sumi: {
                S4200_02: "Als ich dich gestern im Krankenhaus verlassen habe, hat mir Nobu aufgelauert…",
