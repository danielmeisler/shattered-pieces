namespace Endabgabe {
    export async function ProtagonistHospital(): ƒS.SceneReturn {
        ...
        await ƒS.Sound.fade(sound.float_track, 0.2, 3, false);
        ...
        switch (tvOrWalk) {
            ...
            case tvOrWalkAnswer.walk:
                ...
                await ƒS.Sound.play(sound.float_track, 0.2, true);
                await ƒS.update(5);
                await ƒS.Speech.tell(characters.sumi, text.Sumi.S2230_01);
                await ƒS.Location.show(locations.protagonistHospitalRoom_evening);
                await ƒS.Character.show(characters.sumi, characters.sumi.pose.normal_flipped, new ƒS.Position(-480, ƒS.positions.bottomcenter.y));
        ...
        switch (flirtOrNot) {
            case flirtOrNotAnswer.not:
                ƒS.Speech.hide();
                await ƒS.Speech.tell(characters.sumi, "Ich sollte gehen, bis morgen.");
                ƒS.Speech.hide();
                await ƒS.Character.animate(characters.sumi, characters.sumi.pose.shy, animate(animations.leftToLeftOut));
                break;
